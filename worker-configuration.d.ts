/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings` (hash: 57abb928073435d3a0eed1311cd9b146)
// Runtime types generated with workerd@1.20260521.1 2026-05-22 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	OBSIDIAN_QUERIES: KVNamespace;
	CF_IMAGES: ImagesBinding;
	PUBLIC_BASE_URL: "https://open.axross.app";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/common/worker");
	}
