...
- MUST check whether a helper already exists in `app/_/helpers/**`.
- MUST check whether a colocated test pattern already exists next to related code.
- SHOULD prefer built-in Web, Node, React, Next.js, or zod APIs when they solve the problem cleanly.
