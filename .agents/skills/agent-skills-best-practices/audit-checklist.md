...
3. Check section anatomy and RFC-2119 guideline bullets.
4. Check relative links outside code fences.
5. Review content ownership and project fit.
6. Report prioritized improvement rooms.
...
- SHOULD report improvement rooms in priority order instead of listing every small observation.
...
- MUST check that every substantive section has a `**Guidelines:**` block after its explanation or demonstration.
...
- SHOULD group improvement rooms by skill or source-of-truth theme.
